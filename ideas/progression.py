...
def main():
    ...
    scale, progression, roman_progression, chord_names = generate_progression(root, scale_type)

    print(f"Root: {root}")
    print(f"Scale Type: {scale_type}")
    print(f"Scale: {scale}")

    print("Chord Progression (Notes):")
    for chord in progression:
        print(chord)

    print("Chord Progression (Chord Names):")  # New output
    print(chord_names)


    print("Chord Progression (Roman Numerals):")
    
    print(roman_progression)
